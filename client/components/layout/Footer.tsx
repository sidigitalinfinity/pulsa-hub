      ...
      <div className="container grid gap-8 py-10 md:grid-cols-4">
        <div>
          ...
          <p className="mt-3 text-sm text-muted-foreground max-w-xs">
            Platform top up pulsa, paket data, dan voucher game instan. Harga
            kompetitif untuk pelanggan dan reseller.
          </p>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
              <Link to="/#pulsa" className="hover:text-foreground">
                Pulsa
              </Link>
            </li>
            <li>
              <Link to="/#paket-data" className="hover:text-foreground">
                Paket Data
              </Link>
            </li>
            <li>
              <Link to="/#voucher-game" className="hover:text-foreground">
                Voucher Game
              </Link>
            </li>
            <li>
              <Link to="/#topup-game" className="hover:text-foreground">
                Top Up Game
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li>
              <Link to="/developers#limits" className="hover:text-foreground">
                Rate Limits
              </Link>
            </li>
            <li>
              <Link to="/settlement" className="hover:text-foreground">
                Settlement
              </Link>
            </li>
            <li>
